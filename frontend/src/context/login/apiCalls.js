...
export const login = async (user) => {
    try {
        ...
        if( res.data === "Wrong email provided!" || res.data === "Wrong password or username!" || res.data === "Your email address is not verified! Check your inbox." ){
            Swal.fire({
                title: 'Oops', text: res.data, icon: "error"
            });
        }
